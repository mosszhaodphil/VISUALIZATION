...
function plot_surface(data_file_name)
	...
	data_matrix = data_matrix * 100; % PVE is expressed in percentage so it is sensible to use percentage as unit.
	...
	zlabel('Slope (ml/100g/min/%)', 'FontSize', 16, 'FontWeight', 'bold');
